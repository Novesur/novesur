                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input
                              type="text"
                              class="form-control"
                              v-model="fillEditarFamilia.cNombre"
...
export default {
  ...
  methods: {
    getFamiliaById() {
      var url = "/administracion/familia/listByIdFamilia";
      axios
        .get(url, {
          params: {
            nIdFamilia: this.fillEditarFamilia.nIdFamilia,
          },
        })
        .then((response) => {
    ...
    limpiarCriteriosBsq() {
      this.fillEditarFamilia.cNombre = "";
    },
    ...
    validaRegistrarMaterial() {
      ...
      if (!this.fillEditarFamilia.cNombre) {
    ...
    setEditarFamilia() {
      var url = "/administracion/familia/setEditarfamilias";
      axios
        .post(url, {
          nIdFamilia: this.fillEditarFamilia.nIdFamilia,
          cNombre: this.fillEditarFamilia.cNombre,
        })
        .then((response) => {
          Swal.fire({
            icon: "success",
