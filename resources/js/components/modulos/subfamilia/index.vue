  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">SubFamilia</h1>
          </div>
        </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                <input
                                  ...
                                  class="form control"
                                  style="width: 410px"
                                  @keydown.enter.prevent="getListarSubfamilia"
                                  v-model="fillBsqSubfamilia.cNombre"
                                />
                              </div>
                            </div>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-4 offset-4">
                        <button
                          ...
                          @click.prevent="getListarSubfamilia"
                        >
                          Buscar
                        </button>
                        <button
...
export default {
  ...
  computed: {
    pageCount() {
      let a = this.listSubfamilia.length,
        b = this.perPage;
    ...
    listarSubfamiliaPaginated() {
      ...
      return this.listSubfamilia.slice(inicio, fin);
    },
    pagesList() {
      let a = this.listSubfamilia.length,
        b = this.perPage;
  ...
  methods: {
    limpiarCriteriosBsq() {
      this.fillBsqSubfamilia.cNombre = "";
    },
    LimpiarBandejaSubfamilia() {
      this.listSubfamilia = [];
    },
    getListarSubfamilia() {
      var url = "/administracion/subfamilia/getListarSubfamilia";
      axios
        .get(url, {
          params: {
            cNombre: this.fillBsqSubfamilia.cNombre,
          },
        })
        .then((response) => {
