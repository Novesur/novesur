                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input
                            type="text"
                            class="form-control"
                            v-model="fillBsqPermiso.cNombre"
                            @keyup.enter="getListarPermisos"
                          />
                        </div>
                      </div>
                    </div>
            ...
            <div class="card card-info">
              ...
              <div class="card-body table-responsive">
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(item, index) in listarPermisosPaginated"
                      :key="index"
                    >
...
export default {
  ...
  methods: {
    ...
    getListarPermisos() {
      var url = "/administracion/permiso/listPermisos";
      axios
        .get(url, {
          params: {
            'cNombre': this.fillBsqPermiso.cNombre,
            'cSlug': this.fillBsqPermiso.cUrl,
          },
        })
        .then((response) => {
